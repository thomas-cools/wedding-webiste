...
const EMAIL_STRINGS: Record<EmailLocale, EmailStrings> = {
  en: {
    ...
    events: 'Events',
    fridayWelcomeDinner: 'Tuesday Welcome Dinner',
    saturdayCeremonyReception: 'Wednesday Ceremony & Reception',
    sundayBrunch: 'Thursday Brunch',
  ...
  es: {
    ...
    events: 'Eventos',
    fridayWelcomeDinner: 'Cena de bienvenida (martes)',
    saturdayCeremonyReception: 'Ceremonia y recepción (miércoles)',
    sundayBrunch: 'Brunch (jueves)',
  ...
  nl: {
    ...
    events: 'Evenementen',
    fridayWelcomeDinner: 'Welkomstdiner (dinsdag)',
    saturdayCeremonyReception: 'Ceremonie & receptie (woensdag)',
    sundayBrunch: 'Brunch (donderdag)',
