...
export const AccommodationSection: React.FC<AccommodationSectionProps> = ({ enabled }) => {
  ...
  const sectionMaxW = 'container.xl'
  const contentMaxW = '960px'
  ...
  return (
    <Box id="travel" py={[16, 20, 24]} scrollMarginTop={["100px", "130px", "150px"]}>
      <Container maxW={sectionMaxW} px={[4, 6, 8]}>
        <VStack spacing={[8, 10, 12]} align="stretch" w="full">
          ...
          <SimpleGrid columns={[1, 1, 2]} spacing={[6, 8, 10]} alignItems="start" py={[1, 1, 2]} maxW={contentMaxW} w="full" mx="auto">
          <Box>
            <Image
              src={chateauSketch}
          ...
          <SimpleGrid columns={[1, 1, 2]} spacing={[6, 8, 10]} alignItems="center" py={[1, 1, 2]} maxW={contentMaxW} w="full" mx="auto">
          <Box>
          ...
          <VStack spacing={[4, 5, 6]} align="stretch" w="full" maxW={contentMaxW} mx="auto" py={[1, 1, 2]}>
          ...
          <SimpleGrid columns={[1, 2]} spacing={[6, 8]} alignItems="center" w="full" py={[1, 1, 2]} maxW={contentMaxW} mx="auto">
          <VStack align="start" spacing={6}>
